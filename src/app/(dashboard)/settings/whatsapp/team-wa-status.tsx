    ...
    <Card>
      ...
      <CardContent>
        ...
        <div className="mt-4 p-3 rounded-lg bg-primary-50 border border-primary-100 text-[11px] text-primary-700 leading-relaxed">
          💡 <strong>كيف تعمل سلسلة fallback:</strong> عند إرسال ترحيب أو تذكير لعميل،
          النظام يفضّل استخدام رقم المنسق المسؤول (لو ربط رقمه وفعّله).
          لو لم يربط، يستخدم رقم العيادة الموحّد (الإعدادات أعلاه).
          العميل لا يستلم رسالتين مختلفتين — يستلم من رقم واحد ثابت.
        </div>
      </CardContent>
    </Card>
  );
